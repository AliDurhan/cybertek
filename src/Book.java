...
//    	word = word.toLowerCase();
    ...
    public static Boolean isTitleWord(String word) {
    	...
    	ArrayList <String> list = new ArrayList <> (Arrays.asList("a" , "an", "the", "and", "but", 
    									"for", "nor", "or", "so", "yet", "at", "by", "in", "into", 
    									"near", "of", "on", "to", "than", "via"));
...
//    	if (word.equals("a")||word.equals("an")||word.equals("the")||word.equals("and")||word.equals("but")||
//    			word.equals("but")||word.equals("for")||word.equals("nor")||word.equals("or")||word.equals("so")||
//    			word.equals("yet")||word.equals("at")||word.equals("by")||word.equals("in")||word.equals("into")||
//    			word.equals("near")||word.equals("of")||word.equals("on")||word.equals("to")||word.equals("than")||
//    			word.equals("via")) {
//    		return false;
//    	}
//    	
    ...
    public void setAuthor(String author) {
        ...
        if(author.equals("")) {
        	...
        	for (int i = 0; i < str.length; i++) {        	
        		words += capitalize(str[i]) + " ";
        	} 
        	
//        	words = words.substring(0, words.length()-1);
//        	Buna gerek yok cunku trim ile asagida bunu halledebiliyoruz.
        	
        	this.author = words.trim();
...
//   STRINGBUILDER ILE     
//		StringBuilder result = new StringBuilder(author.length());
...
//        	title = title.toLowerCase();
            ...
            String words = "";
            words += capitalize(str[0])+" ";
            
            for (int i = 1; i < str.length; i++) {  
            	
            	if (isTitleWord(str[i])) {
...
// BURADA AUTHOR SOYISMININ BASHARFINI MI ISTIYOR SADECE?
